...
<body>
	<nav>
      ...
      <ul id="dropdown" class="dropdown-content" style="width: 200px">
		...
		<div class="nav-wrapper">
			<a href="/bsym/web/bloglistPage/${blogInfo.division}?broadcastName=${blogInfo.broadcastName}" class="brand-logo center"> <img
	...
	<div class="cook_main">
		<div class="bs_login_container">
			<div class="row">
				<form class="col s12" id="form" name="form" method="POST" action="/bsym/auth/joinProcess" onsubmit="return validateJoin()">
					<div class="row">
