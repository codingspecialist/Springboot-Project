...
<body>
	<nav>
		<div class="menu_bar_left">
			<ul id="nav-mobile" class="left hide-on-med-and-down">
				...
				<li><a href="/bsym/web/myPage/${loginUser.id}">마이페이지</a></li>
			</ul>
		</div>
		<div class="nav-wrapper">
			<a href="/bsym/web/bloglistPage/res?broadcastName=미식클럽" class="brand-logo center">	<!-- 요리페이지 새로고침 -->
	...
	<%	for(i=check; i<castName.length; i++){ %>
		<a class="carousel-item" href="#" id="<%=castName[i]%>"><%=castName[i]%><img src="/image/res/subimg<%=i+1%>.png "></a> 
	<% }%>
	<%	for(i=0; i<check; i++){ %>
		<a class="carousel-item" href="#" id="<%=castName[i]%>"><%=castName[i]%><img src="/image/res/subimg<%=i+1%>.png "></a> 
	<% }%>
