...
<body>
	<nav>
		...
		<div class="nav-wrapper">
			<a href="/bsym/web/bloglistAll/cook?broadcastName=스페인하숙" class="brand-logo center">	<!-- 요리페이지 새로고침 -->
			<img src="/image/cook/main_logo.png"></a>
		</div>
		<div class="menu_bar_right">
			<ul id="nav-mobile" class="left hide-on-med-and-down">
				<li><a href="/bsym/web/bloglistAll/res?broadcastName=미식클럽">방송맛집</a></li>
			</ul>
		</div>
	</nav>
	...
	<%	for(i=check; i<castName.length; i++){ %>
		<a class="carousel-item" href="#" id="<%=castName[i]%>"><%=castName[i]%><img src="/image/cook/subimg<%=i+1%>.png "></a> 
	<% }%>
	<%	for(i=0; i<check; i++){ %>
		<a class="carousel-item" href="#" id="<%=castName[i]%>"><%=castName[i]%><img src="/image/cook/subimg<%=i+1%>.png "></a> 
	<% }%>
