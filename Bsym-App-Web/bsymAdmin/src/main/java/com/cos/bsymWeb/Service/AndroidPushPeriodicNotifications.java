...
public class AndroidPushPeriodicNotifications {
    ...
    public static String PeriodicNotificationJson(String title, String content) throws JSONException{
		...
		try {
			notification.put("title",URLEncoder.encode(content, "UTF-8"));//URLEncoder.encode("방송요리맛집이당ㅋㅋㅋ", "UTF-8"));
			notification.put("body",URLEncoder.encode(title, "UTF-8"));//+localDate.getDayOfWeek().name()+"!");
