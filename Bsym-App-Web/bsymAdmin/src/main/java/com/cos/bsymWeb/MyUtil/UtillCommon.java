...
public class UtillCommon {
	...
	public static String imgFile(String imglink, int lastCount) {
		try {
			...
			String adminFilePath = getAdminResourcePath()+"/"+(lastCount+1)+".jpg";
			File file = new File(filePath);
			File adminFile = new File(adminFilePath);
			ImageIO.write(image, "jpg", file);
			ImageIO.write(image, "jpg", adminFile);
			return filePath;
	...
	public static String getAdminResourcePath() {
		return "E://spring_instagrem//bsymAdmin//src//main//resources//static//image//sumnail";
	}
